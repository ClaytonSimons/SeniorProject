...
namespace UPClient
{
    public class KeyboardHookArgs : EventArgs
    {
        ...
        public KeyboardHookArgs(int vk,int scan,int flag,int t)
        {
            vkCode = vk;
            scanCode = scan;
            flags = flag;
    ...
    public class KeyLogger
    {
        ...
        {
            //indicates if any of underlaying events set e.Handled flag
            bool handled = false;
            ...
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                if (KeyPress != null && wParam == WM_KEYDOWN)
                {
                                ...
                                MyKeyboardHookStruct.flags) == 1)
                    {
                        ...
                        KeyboardHookArgs ea = new KeyboardHookArgs(key,
                            MyKeyboardHookStruct.scanCode,
