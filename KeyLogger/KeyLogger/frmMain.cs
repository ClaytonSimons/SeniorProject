    ...
    public partial class FrmMain : Form
    {
        ...
        private void mnuItem_Settings_Click(object sender, EventArgs e)
        {
            ...
            if (_option.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    _emailparams = new Params(null, _option.txt_emailAddress.Text, _option.txt_emailpassword.Text,
                                             _option.txt_smtpServer.Text, Convert.ToInt32(_option.txt_smtpport.Text),
